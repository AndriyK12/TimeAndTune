...
public partial class TTContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.Soundid).HasName("sound_pkey");

            entity.ToTable("sound");

            entity.HasIndex(e => e.Soundname, "sound_soundname_key").IsUnique();

            entity.Property(e => e.Soundid).HasColumnName("soundid");
            entity.Property(e => e.Audiofilepath)
                .HasMaxLength(255)
                .HasColumnName("audiofilepath");
            entity.Property(e => e.Photofilepath)
                .HasMaxLength(255)
                .HasColumnName("photofilepath");
